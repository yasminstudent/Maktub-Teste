...
<html lang="pt-br">
  <head>
    ...
    <style>
      .bg-blue-dark {
        background-color: #296dd5 !important;
      }
      .bg-blue {
        background-color: #19b8d4 !important;
      }
      .bg-blue-dark2 {
        background-color: #3c5899 !important;
      }
      .bg-blue2 {
        background-color: #4384fc !important;
      }
      .bg-gray {
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="d-flex flex-column align-items-center">
              <h1 class="w-75 mt-3">Where does it come from?</h1>
              <p class="w-75 mb-3">
          ...
          <div class="col-md-6">
            <img src="images/saude.jpg" alt="imagem" class="w-100 h-100" />
          </div>
        </div>
      </div>
    </section>
