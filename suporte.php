...
<html lang="pt-br">
  ...
  <body>
    ...
    <section>
      <div class="container">
        <h1 class="display-4 text-gray text-center mt-4 mb-4">
          Dúvidas? A gente te ajuda.
        </h1>

        <form class="form-inline w-75 ml-auto mr-auto d-flex justify-content-center">
        ...
        <div class="w-100 d-flex justify-content-center">
          <div class="bg-gray container-duvidas w-75">
